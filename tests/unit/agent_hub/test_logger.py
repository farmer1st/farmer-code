...
class TestQALogEntryWithSessionId:
    """Tests for session_id in QALogEntry (T064 - US5)."""

    def test_qa_log_entry_includes_session_id(self) -> None:
        """Test that QALogEntry can include session_id field."""
        from agent_hub.models import QALogEntry
    ...
    def test_qa_log_entry_session_id_is_optional(self) -> None:
        """Test that session_id is optional for backwards compatibility."""
        from agent_hub.models import QALogEntry
    ...
    def test_qa_log_entry_serializes_session_id(self) -> None:
        """Test that session_id is included in serialized output."""
        from agent_hub.logger import QALogger
        from agent_hub.models import QALogEntry
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Retrieve and verify session_id is present
            entries = logger.get_logs_for_feature("005-user-auth")
            assert len(entries) == 1
