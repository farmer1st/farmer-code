"""POST /invoke endpoint for Marie agent service."""
...
from src.core.agent import AgentError, MarieAgent
...
class InvokeRequest(BaseModel):
    ...
    topic: str = Field(
        ...,
        description="Topic type (testing, edge_cases, qa_review)",
    )
...
async def invoke_agent(request: InvokeRequest) -> InvokeResponse:
    """Invoke Marie agent with a topic request.
