"""Agent dispatcher for Knowledge Router.

This module handles spawning Claude CLI to dispatch questions to agents
and parse their structured JSON responses.
"""
...
class AgentDispatcher:
    """Dispatches questions to agents via Claude CLI."""
